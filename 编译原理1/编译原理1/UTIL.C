...
void printTree(TreeNode * tree)
{
	...
	INDENT;
	while (tree != NULL) {
		//if (tree->nodekind == StmtK && (tree->kind.stmt == DecK || tree->kind.stmt == ComK || tree->kind.stmt == LocK || tree->kind.stmt == IfK || tree->kind.stmt == ElseK)) UNINDENT;
		printSpaces();
